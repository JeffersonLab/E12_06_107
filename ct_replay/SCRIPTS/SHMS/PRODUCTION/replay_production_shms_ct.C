void replay_production_shms_ct(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/pass2/shms_coin_replay_production_%d_%d.root";
  ...
  analyzer->SetSummaryFile(Form("REPORT_OUTPUT/SHMS/PRODUCTION/pass2/summary_coin_production_%d_%d.report", RunNumber, MaxEvent));  // optional
  // Start the actual analysis.
  analyzer->Process(run);
  // Create report file from template
  analyzer->PrintReport("TEMPLATES/SHMS/PRODUCTION/pstackana_production.template",
  			Form("REPORT_OUTPUT/SHMS/PRODUCTION/pass2/replay_shms_coin_production_%d_%d.report", RunNumber, MaxEvent));  // optional
